...
- How can we test/compare models once we do log transformations for both explanatory and responses    variables?
- Once we do logTime, AIC becomes negative. What do we do with that?
